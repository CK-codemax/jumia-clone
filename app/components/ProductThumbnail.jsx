...
export default function ProductThumbnail({product}) {
  return (
    <Link className="border border-black xl:hover:shadow-md xl:hover:scale-105 relative rounded-md p-2 flex flex-col space-y-2 justify-center" href={`/individual-product/${product.id}`}>
